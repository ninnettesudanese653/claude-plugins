    ...
    return {
        tools: [
            ...
            // LinkedIn Posts Search
            {
                ...
                description: "Search for posts on LinkedIn. Navigates to search results filtered to Posts. " +
            ...
            // LinkedIn Profile & Connection Tools (handle navigation internally)
            {
                ...
                description: "Send a connection request on LinkedIn. Automatically navigates to the profile if needed. " +
            ...
            },
            {
                ...
                description: "Get LinkedIn profile information. Navigates to the profile and extracts data in one call. " +
            ...
            },
            {
                ...
                description: "Check the connection status with a LinkedIn user without sending a request. " +
            ...
            },
            {
                ...
                description: "Engage with a LinkedIn post visible on the current feed or search results page. " +
    ...
    try {
        switch (name) {
            ...
            case "socials_generate_reply": {
                ...
                const result = await bridge.generateReply(parsed.platform, parsed.post_content, parsed.post_author, parsed.persona_id, parsed.mood);
                return {
                    content: [
                        {
                            type: "text",
